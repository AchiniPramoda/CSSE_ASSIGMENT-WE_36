...
import 'package:csse_flutter/pages/qrScan.dart';
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                title: Text('QRScan', style: TextStyle(fontSize: 17, color: Theme.of(context).accentColor),),
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => MyCustomWidget()));
                },
              ),
              ListTile(
